...
SELECT * FROM products ORDER BY discounted_price DESC LIMIT 10;
...
SELECT *,(rating*rating_count) as comb_rating FROM products
...
# 8. Finding the worst rated product by nike where rating > 0

SELECT * FROM products WHERE rating > 0 and brand_name = 'Nike'
...
# 10. Finding the top 10 best rated tshirt from nike or adidas | rating*rating_count

SELECT *,(rating*rating_count) FROM products
...
select product_name , rating, rating_count, brand_tag, product_tag, discounted_price, product_link from products
...
# 13. Sort the products in alphaetical descending order based on their product_name and 
-- show the last 10 of them
...
# 15. Finding the list of tshirts from nike and adidas prices between 1000 and 1200 
