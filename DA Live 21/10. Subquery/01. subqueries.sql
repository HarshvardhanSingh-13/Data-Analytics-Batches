...
-- Q) Which restaurant has the highest Cost ?


SELECT * FROM swiggy WHERE cost = (SELECT MAX(cost) FROM swiggy);
...
SELECT MIN(rating_count) FROM swiggy
WHERE city = 'abohar';

SELECT * FROM swiggy 
WHERE rating_count = (SELECT MIN(rating_count) FROM swiggy
WHERE city = 'abohar') and city = 'Abohar';


-- Which restaurant of Bangalore has the highest visiting count.

SELECT * FROM swiggy where CITY = 'Bangalore'
AND 
rating_count = (SELECT MAX(rating_count) FROM swiggy WHERE city = 'Bangalore');
...
SELECT MAX(cost*rating_count) FROM swiggy;

SELECT * FROM swiggy 
WHERE cost*rating_count = (SELECT MAX(cost*rating_count) FROM swiggy);


-- Which restaurant of Bangalore has generated the maximum Revenue.

SELECT MAX(cost*rating_count) FROM swiggy WHERE city = 'Bangalore';

SELECT * FROM swiggy
WHERE CITY = 'Bangalore' AND 
cost*rating_count = (SELECT MAX(cost*rating_count) FROM swiggy WHERE city = 'Bangalore');
