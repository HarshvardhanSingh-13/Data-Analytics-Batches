...
-- Find Total Revenue Generated and Total Products Sold in tshirt category

SELECT SUM(rating_count*discounted_price) as "Revenue",SUM(rating_count) as "Sold"
...
-- For these brands Nike, Puma, Adidas, Red Tape, HRX by Hritik Roshan
...
SELECT COUNT(product_name) FROM products WHERE brand_name = "Nike";
...
SELECT COUNT(DISTINCT(product_tag)) FROM products WHERE brand_name = 'nike';
